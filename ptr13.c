...
int main() {
  ...
  *(int *)MyTabInt = 1; // type casting: force pointer agar bertipe int
  ...
  //
  // printf(" [size of TabInt %i] ",
  // sizeof(MyTabInt)); printf(" %d\t", (*(int *)MyTabInt)); printf(" %p\n",
  // (int *)(MyTabInt)); for (i = 0; i < 40; i++) {
  ...
  geser((int *)MyTabInt, ((void *)(int *)succI));
  ...
  geser((int *)MyTabInt, ((void *)(int *)predI));
